    ...
    <div>
      <div className="form">
        ...
        <div className="regi">
          <div className="py-6">
            <div 
              className="flex bg-white rounded-leg justify-center shadow-lg  
              overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
              ...
              <a onClick={handleSignin} class="flex items-center h-9 justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
               ...
               <div className="mt-4">
                <label htmlFor="email" className="border-b text-gray-500 text-sm font-bold mb-2">Email</label>
               ...
               <div className="mt-4">
                <label htmlFor="password" className="border-b text-gray-500 text-sm font-bold mb-2">Password</label>
                <input type="email" value={password} onChange={(e)=>setPassword(e.target.value)} className="text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" id="password" />
               </div>
               <div className="mt-4 flex justify-between">
                <div>
                <label htmlFor="Fname" className="border-b text-gray-500 text-sm font-bold mb-2">First Name</label>
                <input type="email" className="text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" id="Fname" value={fname} onChange={(e)=>setFname(e.target.value)} />
                </div>
                <div className="ml-5"> 
                <label htmlFor="Lname" className="border-b text-gray-500 text-sm font-bold mb-2">Last Name</label>
                <input type="email" className="text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" id="Lname" value={lname} onChange={(e)=>setLname(e.target.value)} />
                </div>
               
               </div>
               <small>By signing up you agree toour  <span className="text-blue-500">Terms and Conditions</span></small>
            <br />
              <button className="bg-blue-500 h-9 text-white font-bold py-2 px-4 mt-4 w-full rounded hover:bg-blue-600">Sign Up</button>
        ...
        {isDivVisible && (
         ...
         items-center h-9 justify-center mt-4 text-white bg-slate-100 rounded-lg hover:bg-gray-100"
                      >
                        ...
                        <h4 className="text-gray-500 heading1">Login With Google</h4>
                      </p>
