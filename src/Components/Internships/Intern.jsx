...
function Intern() {
  ...
  const filterInternships = (category, location) => {
    if (InternData && InternData.length > 0) {
      const filterData = InternData.filter((internship) => {
        // Ensure internship object and its properties are defined
        if (
          internship &&
          internship.category &&
          internship.location
        ...
        return false; // Filter out undefined internships or missing properties
      });
  ...
  useEffect(() => {
    filterInternships(searchCategory, searchLoaction);
    ...
    <>
      <div className="flex internship-filter">
        ...
        <div className="all-internships">
          <div className="head  text-lg justify-center ">
          ...
          <p className="head font-bold text-lg justify-center ">
