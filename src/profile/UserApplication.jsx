...
const userapplication=application.filter(app=>app.user?.name===user.name)
  ...
  useEffect(() => {
    const fetchApplication = async () => {
      const response = await axios.get("https://internshipbackend-teng.onrender.com/api/application");
  ...
  return (
    <div>
      <div className="hide">
        <h1 className="text-3xl font-semibold mt-3">Total Application</h1>
        <div className="flex justify-center" id="table">
          <div className="application flex flex-col mt-7">
                ...
                <tbody>
                    ...
                    {userapplication.map((data) => (
                      ...
                      <tr key={data._id} className="border-b">
                        ...
                        <td className="whitespace-nowrap px-6 py-4">
                          <Link to={`/userapplicationdetail?q=${data._id}`}>
                ...
                <div className="p-4 lg:w-1/2 md:w-full">
                  <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="leading-relaxed text-base">
                        {" "}
                        Applied by: {data.user ? data.user.name : 'Unknown'}
                      </p>
                      <p className="leading-relaxed text-base">
                        {" "}
                      ...
                      <Link
                        to={`/userapplicationdetail?q=${data._id}`}
