    ...
    <div className='flex item-center mt-9 mb-4 justify-center'>
        <div className='max-w-xs'>
                <div className="bg-white shadow-lg rounded-lg py-3">
                    ...
                    <div className="p-2">
                      <h3 className='text-lg font-bold'>UID</h3>
...
<span class="relative w-full text-left text-white transition-colors duration-200 ease-in-out group-hover:text-blue-600">View Applications</span>
</Link>
</div>
                </div>
        </div>
